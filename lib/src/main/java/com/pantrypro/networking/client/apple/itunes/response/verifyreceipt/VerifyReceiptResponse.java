package com.pantrypro.networking.client.apple.itunes.response.verifyreceipt;

import com.fasterxml.jackson.annotation.JsonIgnoreProperties;
import com.pantrypro.networking.client.apple.itunes.response.AppleItunesBaseResponse;
