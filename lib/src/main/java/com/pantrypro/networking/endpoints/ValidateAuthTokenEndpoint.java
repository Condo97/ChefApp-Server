...
public class ValidateAuthTokenEndpoint {
    ...
    public static ValidateAuthTokenResponse validateAuthToken(AuthRequest request) throws DBSerializerException, SQLException, DBObjectNotFoundFromQueryException, InterruptedException, InvocationTargetException, IllegalAccessException, NoSuchMethodException, InstantiationException, AuthTokenExpiredException {
