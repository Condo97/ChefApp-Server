...
import com.pantrypro.apple.apns.APNSClient;
...
public class SendPushNotificationEndpoint implements Endpoint<SendPushNotificationRequest> {

    private static final String deviceTokenPathPrefix = "/3/device/";

    public static void sendPushNotification(SendPushNotificationRequest request) throws UnrecoverableKeyException, CertificateException, IOException, KeyStoreException, NoSuchAlgorithmException, InvalidKeySpecException, URISyntaxException, InterruptedException, DBSerializerException, SQLException, InvocationTargetException, NoSuchMethodException, InstantiationException, IllegalAccessException {
    ...
    @Override
    public Object getResponse(SendPushNotificationRequest request) throws Exception {
