...
import com.pantrypro.model.http.client.apple.itunes.response.status.AppStoreStatusResponseLastTransactionItem;
import com.pantrypro.model.http.client.apple.itunes.response.status.AppStoreStatusResponseSubscriptionGroupIdentifierItem;
