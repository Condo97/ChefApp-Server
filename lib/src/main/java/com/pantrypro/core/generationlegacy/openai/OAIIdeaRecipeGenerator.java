...
//import com.pantrypro.model.http.client.oaifunctioncall.request.builder.OAIGPTChatCompletionRequestFunctionCreatePreliminaryRecipeBuilder;
...
//
//public class OAIIdeaRecipeGenerator {
//
//    private static final String systemMessagePrefix = "You are a chef.";
//
//    public static OAIGPTFunctionCallResponseCreatePreliminaryRecipe generateCreateRecipeIdeaFunctionCall(String ingredientsString, String modifiersString, Integer expandIngredientsMagnitude, int characterLimit, int responseTokenLimit, AtomicReference<String> outInput) throws DBSerializerException, SQLException, InterruptedException, InvocationTargetException, IllegalAccessException, NoSuchMethodException, InstantiationException, OpenAIGPTException, IOException {
//        // Create request function
//        OAIGPTChatCompletionRequestFunction requestFunction = OAIGPTChatCompletionRequestFunctionCreatePreliminaryRecipeBuilder.build(IdeaRecipeExpandIngredients.from(expandIngredientsMagnitude).getFunctionDescription());
//
//        // Create system input
...
//        OAIGPTFunctionCallResponseCreatePreliminaryRecipe functionCallResponse = parseCreateRecipeIdeaResponse(response.getChoices()[0].getMessage().getFunction_call().getArguments());
//
...
//        String ideaRecipeSystemMessage = ideaRecipeExpandIngredients.getSystemMessage();
//
...
//    }
//
//    private static OAIGPTFunctionCallResponseCreatePreliminaryRecipe parseCreateRecipeIdeaResponse(String functionCall) throws IOException {
//        // Parse with object mapper
//        return new ObjectMapper().readValue(functionCall, OAIGPTFunctionCallResponseCreatePreliminaryRecipe.class);
//    }
//
//}
